...
export default function NewsletterSection() {
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="glass-strong rounded-2xl p-16">
            ...
            <p className="text-gray-300 text-lg">
              Thanks for signing up, {firstName}! You&apos;ll now receive exclusive BSW deals and alerts straight to your inbox.
            </p>
          </div>
        </div>
      </section>
  ...
  return (
    <FadeInView>
      <section className="relative py-24">
        <div className="orb w-[400px] h-[400px] bg-[#253998] -left-40 top-0" />
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="glass-strong rounded-2xl p-8 md:p-14">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-300 text-lg">
                Sign up for our marketing campaign &amp; <strong className="text-white">SAVE!!</strong>
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="max-w-xl mx-auto space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm text-gray-400 mb-1.5">
                    <FontAwesomeIcon icon={faUser} className="mr-1.5 text-accent" />
              ...
              <div>
                <label className="block text-sm text-gray-400 mb-1.5">
                  <FontAwesomeIcon icon={faEnvelope} className="mr-1.5 text-accent" />
              ...
              <div>
                <label className="block text-sm text-gray-400 mb-1.5">
                  <FontAwesomeIcon icon={faPhone} className="mr-1.5 text-accent" />
              ...
              <div className="space-y-3">
                <label className="flex items-start gap-3 cursor-pointer group">
                  ...
                  <span className="text-gray-400 text-xs leading-relaxed group-hover:text-gray-300 transition-colors">
                    By checking this box and clicking &ldquo;SIGN UP AND SAVE&rdquo; you consent to receive
                    marketing text messages for notifications and alerts from BSW Outlet. Reply STOP to opt out.
                    Reply HELP for help. Message and data rates may apply. Message frequency may vary.
                  </span>
                </label>
                <label className="flex items-start gap-3 cursor-pointer group">
                  <input
