...
import {
  faMapMarkerAlt, faPhone, faClock, faPaperPlane, faLocationDot,
      ...
      <section className="relative py-24 md:py-32 bg-grid">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <FadeInView>
            ...
            <p className="text-xl text-gray-300">We&apos;d love to hear from you. Reach out with questions, feedback, or just to say hi.</p>
          </FadeInView>
        </div>
      </section>
                ...
                <div className="glass-card p-8">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="text-white font-semibold">BSW Outlet – Winchester</h3>
                        <a href="https://maps.google.com/?q=6777+Winchester+Rd+Memphis+TN" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">6777 Winchester Rd, Memphis, TN 38115</a>
                      </div>
                    </div>
                    <div className="flex items-start gap-4">
                      <div className="w-12 h-12 rounded-full glass flex items-center justify-center text-accent shrink-0">
                      ...
                      <div>
                        <h3 className="text-white font-semibold">BSW Outlet – Summer Ave</h3>
                        <a href="https://maps.google.com/?q=4224+Summer+Ave+Memphis+TN" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">4224 Summer Ave, Memphis, TN 38122</a>
                      </div>
                    </div>
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <a href="tel:+19016951857" className="text-gray-400 hover:text-white transition-colors">(901) 695-1857</a>
                      </div>
                    </div>
                    <div className="flex items-start gap-4">
                      <div className="w-12 h-12 rounded-full glass flex items-center justify-center text-accent shrink-0">
                ...
                <form className="space-y-5">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input type="text" placeholder="John Doe" className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-500 focus:outline-none focus:border-accent/50 focus:bg-white/10 transition-all" />
                    </div>
                    <div>
                      <label className="block text-sm text-gray-400 mb-1.5">Your Email</label>
                      <input type="email" placeholder="john@example.com" className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-500 focus:outline-none focus:border-accent/50 focus:bg-white/10 transition-all" />
                    </div>
                  </div>
                  <div>
                    <label className="block text-sm text-gray-400 mb-1.5">Phone (optional)</label>
                    <input type="tel" placeholder="(901) 555-0123" className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-500 focus:outline-none focus:border-accent/50 focus:bg-white/10 transition-all" />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <textarea rows={5} placeholder="Tell us what's on your mind..." className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-500 focus:outline-none focus:border-accent/50 focus:bg-white/10 transition-all resize-none" />
                  </div>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <FadeInView>
            <div className="glass-strong rounded-2xl p-12">
              <h2 className="text-3xl font-bold text-white mb-4">Stop By Today</h2>
              <p className="text-gray-300 mb-8">No appointment needed. Just walk in and start saving.</p>
