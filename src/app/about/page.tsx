    ...
    <div className="relative">
          ...
          <FadeInView>
            <div className="glass-card p-10">
              ...
              <div className="space-y-4 text-gray-300 leading-relaxed">
                ...
                <p>At <strong className="text-white">BSW Outlet</strong>, every visit is a chance to score something incredible at a price that doesn&apos;t make your wallet flinch. Whether you&apos;re after electronics, tools, home goods, or just love the thrill of the bin hunt, this is your spot.</p>
                <p>You get <strong className="text-white">new inventory weekly</strong>, <strong className="text-white">deal days you won&apos;t believe</strong> ($1, $2, $5, $7), and a store full of people just like you. Ready to dig, find, and win.</p>
              </div>
            </div>
          </FadeInView>
        </div>
      ...
      <section className="relative py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeInView>
            <h2 className="text-3xl sm:text-4xl font-bold text-white text-center mb-12">Take a Look Inside</h2>
          </FadeInView>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeInView>
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400 text-lg">A crew of everyday people who believe saving money should actually be fun.</p>
            </div>
          </FadeInView>
          <FadeInView delay={0.2}>
            <div className="glass-card p-10 text-center">
              <div className="w-24 h-24 rounded-full glass flex items-center justify-center text-3xl mx-auto mb-4">👤</div>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <FadeInView>
            <div className="glass-strong rounded-2xl p-12">
              <h2 className="text-3xl font-bold text-white mb-4">Come Experience the Difference</h2>
              <p className="text-gray-300 mb-8">
                From the front registers to the back of the warehouse, we&apos;re a tight-knit team that&apos;s all about good energy, honest deals, and bringing something real to the community.
              </p>
